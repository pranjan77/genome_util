...
module KBaseCoreGenomeUtil {
	...
	float coverage; 	/*BLAST output parameters*/
	float score; 		/*BLAST output parameters*/
	float identity;  	/*BLAST output parameters*/
    
    } hit;
    
    typedef string gene_id;
    typedef mapping<gene_id, hit> gene_id2hit;
    ...
    funcdef blast_against_genomes(BlastGenomeParams myparams) returns (blast_output_ref) authentication required;
